...
class PoleChudesGame(QMainWindow):
    def __init__(self):
        ...
        self.words_with_questions = {
            "Легкий": [
                {"word": "КОТ", "question": "Домашнее животное, которое мяукает"},
                {"word": "ДОМ", "question": "Место, где живут люди"},
                {"word": "СОН", "question": "Что делает человек ночью?"},
                {"word": "МАК", "question": "Красный цветок с черными семенами"},
                {"word": "РОТ", "question": "Часть лица, которой едят и говорят"},
                {"word": "ЕЖ1", "question": ""}
            ],
            "Средний": [
                {"word": "ПИТОН", "question": "Язык программирования и крупная змея"},
                {"word": "КОДИНГ", "question": "Процесс написания компьютерных программ"},
                {"word": "ПРОГРАММА", "question": "Набор инструкций для компьютера"},
                {"word": "КЛАВИАТУРА", "question": "Устройство ввода для компьютера"}
            ],
            "Сложный": [
                {"word": "АЛГОРИТМ", "question": "Последовательность шагов для решения задачи"},
                {"word": "ИСКУССТВЕННЫЙ", "question": "Не природный, созданный человеком"},
                {"word": "ПРОГРАММИРОВАНИЕ", "question": "Процесс создания компьютерных программ"}
            ]
        }
    ...
    def guess_word(self):
        """Обработчик нажатия кнопки 'Сказать слово'"""
        ...
        if ok and word:
            if word.upper() == self.hidden_word:
                ...
                bonus = len(self.hidden_word) * 100
